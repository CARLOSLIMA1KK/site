...
export const SITE = {
  name: "KodarEdu",
  tagline: "Plataforma educacional completa e white label.",
  description:
    "Plataforma educacional completa e white label: simulados ENEM e SAEB por TRI, Produção Textual com IA, provas com leitor OMR, Banco de Itens, Edu.IA e relatórios. Com a sua marca.",
  descriptionShort:
    "Plataforma educacional completa e white label para escolas, cursinhos, redes e secretarias.",
  whatsapp:
    "https://wa.me/5583987879695?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20sobre%20a%20KodarEdu.",
  whatsappLabel: "Falar com especialista",
  whatsappNumber: "+55 83 98787-9695",
  email: "contato@kodartech.com.br",
  phone: "+55 83 98787-9695",
  phoneHref: "tel:+5583987879695",
...
export const NAV = [
  {
    ...
    columns: [
      {
        items: [
          { label: "Quem Somos", href: "/quem-somos", desc: "Tecnologia, segurança e o time." },
    ...
    columns: [
      {
        title: "Avaliações",
        items: [
          { label: "Provas Online e Impressas", href: "/solucoes/provas" },
      ...
      },
      {
        ...
        items: [
          { label: "Assistente IA do Professor", href: "/solucoes/edu-ia" },
        ],
      },
    ],
  },
...
export const STATS = [
  { value: 300, suffix: " mil+", label: "Estudantes impactados" },
  { value: 4, suffix: "M+", label: "Avaliações aplicadas" },
  { value: 1, suffix: "M+", label: "Produções textuais" },
  { value: 99, suffix: "%", label: "de satisfação", stars: true },
];

// Jornada avaliativa em 4 passos
export const JOURNEY = [
  { step: "01", title: "Criar", text: "Monte provas e simulados em minutos com IA e o Banco de Itens." },
  { step: "02", title: "Aplicar", text: "Online, impresso ou híbrido, do jeito que sua instituição precisa." },
...
export const FEATURED_SOLUTIONS = [
  ...
  },
  {
    ...
    text: "Milhares de itens por disciplina, nível e habilidade, alinhados à BNCC.",
  },
  {
  ...
  },
  {
    ...
    tag: "IA",
    print: "/assets/prints/edu-ia-home.jpg",
...
export const ACCESS_PROFILES = [
  {
    ...
    intro:
      "Para o aluno, a KodarEdu reúne em um só lugar, com a marca da instituição, os simulados, a Produção Textual e a trilha de estudos. Ele acompanha a própria nota TRI, vê onde precisa melhorar e estuda no ritmo dele, no computador ou no app.",
    offers: [
      ...
      "Acesso pelo app, com a marca da instituição",
    ],
  },
  {
    name: "Professor",
  ...
  },
  {
    ...
    slug: "gestao",
    desc: "Acompanha turmas, indicadores e a visão completa da instituição.",
    icon: "chart",
    print: "/assets/prints/perfil-gestor.svg",
    photo: "/assets/personas/gestao.jpg",
    intro:
      "Da coordenação à direção, a KodarEdu entrega a visão completa da instituição: desempenho por turma, disciplina e habilidade, comparativos e evolução, previsibilidade de ENEM/SAEB por TRI e relatórios exportáveis, tudo integrado ao ERP e com a configuração da marca, sem depender de TI.",
    offers: [
      ...
      "Relatórios exportáveis da instituição",
  ...
  },
  {
    ...
    intro:
      "Redes de ensino e secretarias consolidam os dados de todas as unidades em um só painel: comparam instituições, acompanham indicadores SAEB com benchmark nacional e gerenciam tudo de forma centralizada, com conformidade LGPD e BNCC.",
    offers: [
      "Visão consolidada multiunidade",
      "Comparação entre instituições da rede",
...
export const REPORT_VIEWS = [
  ...
  { title: "Por disciplina", text: "Onde a instituição avança e onde precisa reforçar." },
...
export const DIFFERENTIATORS = [
  ...
  "Flexível: online, impresso ou híbrido, do plano essencial ao enterprise de redes.",
...
export const FAQ_HOME = [
  {
    ...
    a: "A plataforma fica com a cara da sua instituição: suas cores, seu logo, seus links, seu domínio e, opcionalmente, um app na sua marca. Os alunos veem a sua instituição, não a KodarEdu.",
  },
  {
...
export const PLANS = [
  {
    ...
    audience: "Escola independente",
    users: "Até 500 usuários",
    priceLabel: "Sob consulta",
    features: [
      "Criação e aplicação de provas",
      "Correção automática (objetiva)",
  ...
  {
    name: "Profissional",
    tagline: "A plataforma educacional completa.",
    audience: "Cursinho ou rede pequena",
    ...
    features: [
      ...
      "Banco de Itens",
      "Simulados ENEM/SAEB por TRI",
      "Produção Textual (IA + especialista)",
      "Trilha adaptativa (CAT)",
      "Provas com IA + correção OMR/câmera",
  ...
  },
  {
    ...
    audience: "Rede multiunidade ou secretaria",
...
export const PLANS_FAQ = [
  ...
  },
  {
    ...
    a: "Sim, oferecemos garantia de 30 dias. Se a plataforma não fizer sentido para a sua instituição nesse período, devolvemos o investimento.",
  },
  {
