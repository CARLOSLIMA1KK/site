...
export const SITE = {
  ...
  description:
    "Plataforma educacional white label de inteligência e gestão avaliativa: simulados por TRI, Produção Textual com IA, Banco de Itens, trilha adaptativa e Edu.IA, com a marca da sua instituição.",
  whatsapp:
