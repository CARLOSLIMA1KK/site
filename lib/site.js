...
export const ACCESS_PROFILES = [
  ...
  },
  {
    name: "Coordenação",
    slug: "coordenacao",
    desc: "Acompanha turmas e indicadores pedagógicos.",
    icon: "chart",
    print: "/assets/prints/perfil-coordenacao.svg",
    photo: "/assets/personas/coordenacao.jpg",
    intro:
      "A coordenação enxerga o desempenho de cada turma, compara resultados e direciona intervenções pedagógicas com base em dados — competência a competência, com as réguas ENEM/SAEB por TRI.",
    offers: [
      "Indicadores por turma, disciplina e habilidade",
      "Comparativos e ranking entre turmas",
      "Acompanhamento de evolução por ciclo",
      "Identificação de turmas para reforço",
      "Gestão de professores e avaliações",
      "Réguas ENEM/SAEB por TRI",
    ],
  },
  {
    name: "Gestor",
    slug: "gestor",
    desc: "Visão completa da escola e relatórios.",
    icon: "shield",
    print: "/assets/prints/perfil-gestor.svg",
    photo: "/assets/personas/gestor.jpg",
    intro:
      "O gestor tem a visão completa da escola: indicadores-chave, relatórios exportáveis, previsibilidade de ENEM/SAEB e a configuração da marca. Tudo integrado ao ERP, sem depender de TI.",
    offers: [
      "Dashboard com indicadores-chave",
      "Relatórios exportáveis da escola",
      "Previsibilidade de ENEM e SAEB",
