...
export const ACCESS_PROFILES = [
  { name: "Aluno", desc: "Faz avaliações, vê notas, trilhas e evolução.", icon: "rocket", print: "/assets/prints/simulado-andamento.svg" },
  { name: "Professor", desc: "Cria, aplica e corrige avaliações e redações.", icon: "brush", print: "/assets/prints/redacao-correcao.svg" },
  { name: "Coordenação", desc: "Acompanha turmas e indicadores pedagógicos.", icon: "chart", print: "/assets/prints/relatorio-turma.svg" },
  { name: "Gestor", desc: "Visão completa da escola e relatórios.", icon: "shield", print: "/assets/prints/relatorio-gestor.svg" },
  { name: "Rede", desc: "Consolidação multiunidade para secretarias.", icon: "network", print: "/assets/prints/relatorio-habilidade.svg" },
];
