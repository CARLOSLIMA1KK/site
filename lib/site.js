...
export const ACCESS_PROFILES = [
  { name: "Aluno", desc: "Faz avaliações, vê notas, trilhas e evolução.", icon: "rocket", print: "/assets/prints/perfil-aluno.svg" },
  { name: "Professor", desc: "Cria, aplica e corrige avaliações e redações.", icon: "brush", print: "/assets/prints/perfil-professor.svg" },
  { name: "Coordenação", desc: "Acompanha turmas e indicadores pedagógicos.", icon: "chart", print: "/assets/prints/perfil-coordenacao.svg" },
  { name: "Gestor", desc: "Visão completa da escola e relatórios.", icon: "shield", print: "/assets/prints/perfil-gestor.svg" },
  { name: "Rede", desc: "Consolidação multiunidade para secretarias.", icon: "network", print: "/assets/prints/perfil-rede.svg" },
];
