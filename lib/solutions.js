...
export const SOLUTIONS = {
  ...
  adaptativa: {
    ...
    cta: {
      title: "Quero a trilha adaptativa na minha escola",
  ...
  "banco-de-questoes": {
    ...
    cta: {
      title: "Quero o Banco de Itens na minha escola",
  ...
  provas: {
    meta: {
      ...
      description:
        "Crie provas com layout profissional e geração de questões por IA, aplique impresso ou online, e corrija automaticamente (objetiva e discursiva) com leitor de gabarito e integração com ERP.",
    },
    hero: {
      eyebrow: "Recursos Edu",
      ...
      subtitle:
        "Gere questões com IA, monte provas com layout profissional, aplique impresso ou online e deixe a correção automática (objetiva e discursiva) com a KodarEdu.",
      pills: ["Gera questões com IA", "Leitor de gabarito", "Online/Impresso", "Integra ERP"],
      mockup: { src: "/assets/prints/correcao-automatica.svg", alt: "Correção automática e leitor de gabarito", label: "Correção automática" },
    },
    features: {
      title: "Da criação à correção, num só fluxo",
      items: [
        { title: "Geração de questões com IA", text: "Crie itens inéditos e variações em segundos." },
    ...
    split: {
      ...
      text: "O professor gera as questões com IA, monta a prova, escolhe o formato e a KodarEdu cuida da correção e dos relatórios. As notas fluem para o ERP escolar, sem retrabalho.",
      items: ["Geração e edição com IA", "Correção objetiva e discursiva", "Leitor de gabarito", "Notas integradas ao ERP"],
  ...
  integracao: {
    ...
    features: {
      ...
      items: [
        { title: "Aplicação híbrida", text: "Aplique no papel ou online, como a escola precisar." },
    ...
    cta: {
      title: "Quero integração físico-digital na minha escola",
  ...
  "edu-ia": {
    ...
    hero: {
      ...
      mockup: { src: "/assets/prints/edu-ia-professor.svg", alt: "Assistente Edu.IA com ferramentas para o professor", label: "Edu.IA · Assistente" },
    },
    features: {
    ...
    split: {
      ...
      mockup: { src: "/assets/prints/edu-ia-professor.svg", alt: "Geração de material com o Edu.IA", label: "Edu.IA" },
    },
    cta: {
