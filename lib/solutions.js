...
export const SOLUTIONS = {
  ...
  "edu-ia": {
    ...
    split: {
      ...
      mockup: { src: "/assets/prints/edu-ia-home.jpg", alt: "Dashboard do Edu.IA com a marca kodarEdu, mostrando categorias e ferramentas pedagógicas", label: "Assistente IA" },
    },
    cta: {
